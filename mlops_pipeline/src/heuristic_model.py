...
class HeuristicModel(BaseEstimator, ClassifierMixin):
    def __init__(self, puntaje_threshold=650, cuota_ingreso_threshold=0.4,
                 mora_threshold=0, huella_threshold=6, creditos_threshold=8,
                 salario_threshold=5_000_000):
    ...
    def predict(self, X):
        ...
        for _, row in X.iterrows():
            ...
            # Regla 4: Huella de consulta alta -> riesgo
...
plt.title("Matriz de Confusión - HeuristicModel")
plt.show()
